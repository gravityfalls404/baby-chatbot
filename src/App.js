...
class App extends Component {
  ...
  async submitMessage() {
    ...
    const response = await Interactions.send("OrderFlowers_dev", input);
    ...
    if (response.dialogState === 'Fulfilled') {
      if (response.intentName === 'Greetings') {
        const { slots: { Name, Age, House} } = response
        const finalMessage = `It's Nice to meet you ${Name}, we can be good friends.`
